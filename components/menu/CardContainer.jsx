...
export default function CardContainer({category, deleteItem, editItem}) {
  ...
  return (
    <div className={`${isOpen?'max-h-full':'max-h-24'} overflow-hidden mb-6 p-6 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10`}>
        ...
        <div className="grid gap-6 px-4 sm:px-0 grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
