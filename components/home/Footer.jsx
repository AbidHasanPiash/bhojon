      ...
      <div className="bg-gray-50 dark:bg-gray-800 pt-8 md:pt-20">
        <div className="container m-auto space-y-8 px-6 text-gray-600 dark:text-gray-300 md:px-12 lg:px-20">
          <div>
            ...
            <div>
              <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-4">
                {/* Resto Man */}
                <div>
                ...
                <div className="col-span-2">
                  ...
                  <ul className="mt-4 list-inside space-y-4">
                    <li>
                      <Link href={"tel:+8801789507895"}>
                        +880 178 950 7895
                      </Link>
                    </li>
                    <li>
                    <Link href="mailto:mp.abidhasan@gmail.com?subject=Feedback&body=Message">
                        mp.abidhasan@gmail.com
                    </Link>
                    </li>
                    <li>
                      <form>
                        ...
                        <div className="relative mt-4 overflow-hidden">
                          ...
                          <button
                            type="submit"
                            title="Submit"
                            className="absolute right-0 h-full bg-cyan-500 px-6 rounded-r-xl"
                          >
              ...
              <div className="flex justify-between border-t border-cyan-800 py-8 text-gray-200">
                <span>
                  &copy; restoman 2023 - <span id="year">2024</span>
                </span>
